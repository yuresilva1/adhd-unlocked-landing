...
const PricingES = () => {
  const features = [
    ...
    "Bonus: Plantillas de plan de acción personalizadas",
      ...
      <div className="container max-w-4xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-white/90">
            Tu transformación comienza hoy por menos del costo de una sola sesión de terapia.
          </p>
        </div>
        ...
        <div className="bg-white rounded-3xl shadow-strong p-8 md:p-12">
          ...
          >
            Obtener Acceso Instantáneo Ahora - $9.97
          </Button>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Prueba el libro sin riesgo durante 30 días. Si no lo encuentras valioso, 
                  te devolveremos cada centavo. Sin preguntas.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="text-center mt-12 text-white">
          <p className="text-xl mb-4">
            🎯 <strong>Únete a más de 10,000+ lectores</strong> que han transformado su viaje con el TDAH
          </p>
          <p className="text-lg text-white/80">
            La pregunta no es "¿Puedo permitirme este libro?" 
            <br />
            Es "¿Puedo permitirme NO desbloquear todo mi potencial?"
          </p>
        </div>
      </div>
    </section>
