...
const ProblemES = () => {
  const problems = [
    "¿Batallas constantes para mantener el enfoque, terminar tareas o mantener tu vida organizada?",
      ...
      <div className="container max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-6">
            ¿Alguno de Estos <span className="text-primary">Resuena Contigo?</span>
          </h2>
